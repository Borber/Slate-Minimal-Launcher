...
sealed class HomeItem {
     ...
     * hidden, not uninstalled). Surfaced by the `count` folder-style marker so the
    ...
    /**
     * A pinned reference to another app's published shortcut, rendered in the application list.
     */
